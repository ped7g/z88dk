...
int OptionsLexer::lex() {
    ...
    while (true) {
        ...
        break;
        case 36: // rule at line 101: [\x00-\xff] :
        { return false; }
...
S334:
    c1 = m.FSM_CHAR();
    if ('a' <= c1 && c1 <= 'f') goto S397;
    if ('A' <= c1 && c1 <= 'F') goto S397;
    if ('0' <= c1 && c1 <= '9') goto S397;
    return m.FSM_HALT(c1);
...
S384:
    c1 = m.FSM_CHAR();
    if ('a' <= c1 && c1 <= 'f') goto S427;
    if ('A' <= c1 && c1 <= 'F') goto S427;
    if ('0' <= c1 && c1 <= '9') goto S427;
    return m.FSM_HALT(c1);

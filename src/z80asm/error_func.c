...
void error_unbalanced_struct_at(const char* filename, int line_nr) {
    ...
    Str_append_sprintf( msg, "unbalanced control structure started at file '%s' line %d", filename,
                        line_nr );
    do_error( ErrError, Str_data(msg) );
...
void error_obj_file_version(const char* filename, int found_version, int expected_version) {
    ...
    Str_append_sprintf( msg, "object file '%s' version %d, expected version %d", filename,
...
void error_lib_file_version(const char* filename, int found_version, int expected_version) {
    ...
    Str_append_sprintf( msg, "library file '%s' version %d, expected version %d", filename,
                        found_version, expected_version );
    do_error( ErrError, Str_data(msg) );
